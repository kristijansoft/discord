...
extlinks = {
    'issue': ('https://github.com/kristijansoft/discord.py/issues/%s', 'GH-%s'),
...
resource_links = {
  ...
  'issues': 'https://github.com/kristijansoft/discord.py/issues',
  'discussions': 'https://github.com/kristijansoft/discord.py/discussions',
  'examples': f'https://github.com/kristijansoft/discord.py/tree/{branch}/examples',
}
